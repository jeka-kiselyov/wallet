<div class="modal-dialog">
  <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="dialog_label">Add Profit</h4>
      </div>
      ...
      <fieldset>
        ...
        <div class="form-group">
          <label class="sr-only" for="input_description">Description</label>
          <input type="text" name="description" class="form-control" id="input_description" placeholder="Desciption">
        </div>
        ...
        <div class="form-group">
          <input type="submit" class="btn btn-primary pull-left" value="Add" data-loading-text="Saving...">
        </div>
